        ...
        <div class="form first">
            ...
            <div class="fields">
                ...
                <div class="input-field">
                    ...
                    <textarea type="number" placeholder="Job Descriptions" name="jobDescription" required ></textarea>
                </div>
                <div class="input-field">
                ...
                <div class="input-field">
                    ...
                    <textarea type="number" placeholder="Job Responsibilities" name="jobResponsibility" required ></textarea>
                </div>

                <div class="input-field">
                    <label>Requirments</label>
                    <textarea type="number" placeholder="Job Requirments" name="jobRequirment" required ></textarea>
                </div>
                ...
                <div class="input-field">
                    ...
                    <input type="date" placeholder="Application Last Date" required />
                </div>
                <div class="input-field">
                    <label>Salary</label>
